...
class SerialApp:
    def __init__(self, master):
        ...
        self.port_menu.grid(row=0, column=3, columnspan=2)

        self.start_button = ttk.Button(self.master, text="Start ", command=self.start)
        tk.Label(self.master, text="Ports:").grid(row=0, column=1)
