...
from serical import select_port 
...
class App:
    def __init__(self, root):
        ...
        GListBox_468=tk.Text(self.master, height=50, width=30)
        ...
        GLabel_394["text"] = self.settext.Set_port_text()
...
class Settext:
    ...
    def Set_port_text(self):
        ports = [port.device for port in serial.tools.list_ports.comports()]
        port_var = str(ports[0])
        if ports:
            return port_var
