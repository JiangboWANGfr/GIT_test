...
class SerialApp:
    ...
    def receive_data(self):
        ...
        while self.running:
            ...
            voltage = self.receive_data.receive_voltage()
            current = self.receive_data.receive_current()
            ...
            self.text.insert(tk.END, "\n".join([f"{t:.2f}s: {d1:.2f}V, {d2:.2f}A, {d3:.2f}mW" for t, d1, d2, d3 in zip(self.times[-53:], self.voltage[-53:], self.current[-53:], self.power[-53:])]))
