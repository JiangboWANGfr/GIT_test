...
class SerialApp:
    def __init__(self, master):
        ...
        self.master.geometry("800x1000")  # 根据需要调整
        width=672
        height=880
        ...
        romasterot.resizable(width=False, height=False)
        ...
        self.canvas.draw()
        self.canvas.get_tk_widget().place(x=10, y=190, width=500, height=900)

        ft = tkFont.Font(family='Times',size=10)
        self.text = tk.Listbox(self.master, font=ft, borderwidth=1, fg="#333333", justify="center")
        self.text.place(x=510, y=10, width=236, height=1100)
