...
class SerialApp:
    def __init__(self, master):
        ...
        GMessage_689=tk.Label(self.master)
        ...
        # GMessage_689["fg"] = "red"
        GMessage_689["text"] = "nkkj test"
        GMessage_689.place(x=10,y=180,width=500,height=57)


        seltlabel = tk.Label(self.master)
        ft = tkFont.Font(family='Times',size=15)
        seltlabel["font"] = ft
        seltlabel["fg"] = "#333333"
        seltlabel["justify"] = "center"
        seltlabel["text"] = "Select Port"
        seltlabel.place(x=10,y=40,width=140,height=55)
