...
class SerialApp:
    def __init__(self, master):
        ...
        self.GMessage_689=tk.Label(self.master)
        # set Font color to rad
        self.GMessage_689["justify"] = "left"
        ft = tkFont.Font(family='Times',size=15,weight=tkFont.BOLD,slant=tkFont.ITALIC)
        self.GMessage_689["font"] = ft
        self.GMessage_689["fg"] = "red"
        self.GMessage_689["text"] = "Warning: Make sure the device is connected !"
        self.GMessage_689.place(x=10,y=180,width=500,height=57)
