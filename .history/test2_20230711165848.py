...
class SerialApp:
    ...
    def receive_data(self):
        ...
        while self.running:
            # 从串口读取数据
            # voltage, data2, data3 = 0.01, 1.04, 2.45  # 假设读到的数据为0
            ...
            self.text.insert(tk.END, "\n".join([f"{t:.2f}s: {d1:.2f}V, {d2:.2f}A, {d3:.2f}mW" for t, d1, d2, d3 in zip(self.times[-53:], self.voltage[-53:], self.data2[-53:], self.data3[-53:])]))
