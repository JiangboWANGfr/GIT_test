...
class App:
    def __init__(self, root):
        ...
        GListBox_427=tk.Listbox(root)
        GListBox_427["borderwidth"] = "1px"
        ft = tkFont.Font(family='Times',size=10)
        GListBox_427["font"] = ft
        GListBox_427["fg"] = "#333333"
        GListBox_427["justify"] = "center"
        GListBox_427.place(x=50,y=140,width=80,height=25)
